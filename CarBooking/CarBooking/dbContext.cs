...
namespace CarBooking
{
    public class dbContext
    {
        ...
        public decimal calculateRentCost(string personNumber)
        {
            ...
            string query = " SELECT  DistanceCounter_before,  DistanceCounter_after, Date_before, Date_after, Name FROM dbo.CarRent INNER JOIN dbo.Category ON dbo.CarRent.CategoryId = dbo.Category.CategoryId WHERE PersonNumber =@personNumber; ";
